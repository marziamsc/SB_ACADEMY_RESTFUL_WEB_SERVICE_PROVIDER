...
public class SbAcademyRestfulWebServiceProviderApplication {
	...
	/*
	 * Grazie all'annotation @Bean chiediamo espressamente a Spring Boot di caricare, all'avvio dell'applicazione,
	 * il Bean di Hazelcast e possiamo settare un nome per la cache tramite il metodo setInstanceName
	 */
	
	/* COMMENTATO PER PROGETTO FULL STACK
	@Bean
